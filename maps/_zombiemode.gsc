...
init_standard_zombie_anims()
{
	...
	level.scr_anim["zombie"]["sprint4"] = %ai_zombie_sprint_v12;
...
zombie_deathvalley_vision_test()
{
	...
	while( true )
	{
		...
		iPrintLnBold( "SOMEONE ACCESSED TRIGGER SWITCH TO NEW VISION" );
		ghostship_fog();
		visionSetNaked( "cuba_streets_floodlights", 2 );
		wait 4;
		switcher waittill( "trigger", who );
		iPrintLnBold( "SOMEONE ACCESSED TRIGGER SWITCH TO OG VISION" );
		ghostship_fog();
		visionSetNaked( "zombie_deathvalley", 2 );
		wait 4;
	}
}
