...
init()
{
	...
	set_zombie_var( "use_doubletap",					1 );
	set_zombie_var( "use_jugg",					1 );
	set_zombie_var( "use_revive",					1 );
	set_zombie_var( "use_speed",					1 );

	set_zombie_var( "use_tombstone",					0 );				// Use Tombstone
	set_zombie_var( "use_cherry",				1 );				// Use Electric Cherry
	set_zombie_var( "use_vulture_aid",					1 );				// Use Vulture Aid
	set_zombie_var( "use_widows_wine",					1 );				// Use Widows Wine
